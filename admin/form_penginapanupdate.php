			...
			<div class="page-content">
				...
				<div class="card">
					<div class="card-body p-4">
						...
						<form action="penginapan/penginapanupdate.php" method="POST" enctype="multipart/form-data" > 
							<div class="row mb-3">
								<div class="col-sm-9">
							...
							<div class="row mb-3">
								...
								<div class="col-sm-9">
									<input type="text" name="nama_penginapan" value="<?= $row['nama_penginapan']; ?>" class="form-control" id="nama_penginapan" placeholder="Nama Penginapan" required>
								</div>
							</div>
							<div class="row mb-3" >
								<label for="fasilitas" class="col-sm-3 col-form-label">Fasilitas</label>
								<div class="col-sm-9">
									<input type="text" name="fasilitas" value="<?= $row['fasilitas']; ?>" class="form-control" id="fasilitas" placeholder="Fasilitas" required>
								</div>
							</div>
							<div class="row mb-3">
							...
							<div class="row mb-3">
								...
								<div class="col-sm-9">
									<input type="number" name="rating"  value="<?= $row['rating']; ?>" min="1" max="5" class="form-control" id="rating" placeholder="Rating" required>
								</div>
							</div>
							<div class="row mb-3">
								<label for="contact" class="col-sm-3 col-form-label">Contact</label>
								<div class="col-sm-9">
									<input type="number" name="contact" value="<?= $row['contact']; ?>" class="form-control" id="contact" placeholder="Contact" required>
								</div>
							</div>
							<div class="row mb-3">
								<label for="gambar_penginapan" class="col-sm-3 col-form-label">Gambar Penginapan</label>
								<div class="col-sm-9">
									<input type="file" name="gambar_penginapan" value="<?= $row['gambar_penginapan']; ?>" id="gambar_penginapan" accept="images/*" class="form-control" placeholder="Gambar Penginapan">
								</div>
							</div>
							<div class="row mb-3" >
								...
								<div class="col-sm-9">
									...
									name="deskripsi_penginapan"  class="form-control" id="deskripsi_penginapan" placeholder="Deskripsi Penginapan" required><?= $row['deskripsi_penginapan']; ?>
									</tinymce-editor>	
								</div>
								</div>
							</div>
