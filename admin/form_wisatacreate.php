			...
			<div class="page-content">
				...
				<div class="card">
					<div class="card-body p-4">
						...
						<form action="wisata/wisatacreate.php" method="POST" enctype="multipart/form-data" > 
							<div class="row mb-3">
								<div class="col-sm-9">
							...
							<div class="row mb-3">
								...
								<div class="col-sm-9">
									<input type="file" name="gambar_wisata" id="gambar_wisata" accept="images/*" class="form-control" placeholder="Nama Wisata" required>
								</div>
							</div>
							<div class="row mb-3" >
