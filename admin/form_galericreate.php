			...
			<div class="page-content">
				...
				<div class="card">
					<div class="card-body p-4">
						<h5 class="mb-4">Data Galeri Wisata</h5>
						<form action="galeri/galericreate.php" method="POST" enctype="multipart/form-data" > 
							<div class="row mb-3">
								<div class="col-sm-9">
							...
							<div class="row mb-3">
								...
								<div class="col-sm-9">
									...
									<?php while ($row = $result->fetch_assoc()) { ?>
										<option value="<?php echo $row['id']; ?>"><?php echo $row['nama_wisata']; ?></option>
									<?php } ?>
									</select>
								</div>
							</div>
							<div class="row mb-3">
								...
								<div class="col-sm-9">
									<input type="file" name="gambar_wisata[]" id="gambar_wisata" accept="images/*" class="form-control" multiple placeholder="Nama Wisata" required>
								</div>
							</div>
							<div class="row">
